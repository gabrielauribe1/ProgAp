...
gint main ( gint argc, gchar *argv[])
{
  ...
  GtkWidget *ventana;
  GtkWidget *boton;
  GtkWidget *cajah, *subcajah, *cajahCR;
  GtkWidget *cajav, *cajac;
  GtkWidget *cajae;
  GtkWidget *op1;
  GtkWidget *op2;
  GtkWidget *op3;
  ...
  cajahCR = gtk_hbox_new(FALSE,5);
  cajac = gtk_vbox_new(FALSE,5);
  ...
  gtk_box_pack_start(GTK_BOX(cajac),cajah,TRUE,TRUE,5);
  ...
  gtk_box_pack_start(GTK_BOX(cajah),subcajah,TRUE,TRUE,0);
  gtk_box_pack_start(GTK_BOX(cajahCR),cajac,TRUE,TRUE,5);
  gtk_box_pack_start(GTK_BOX(cajav),cajahCR,TRUE,TRUE,5);
  
  // RADIO BUTTONS

  cajav3 = gtk_vbox_new(TRUE,0);

  rb1 = gtk_radio_button_new_with_label(NULL, "Opcion 1");
  gtk_box_pack_start(GTK_BOX(cajav3), rb1, FALSE, FALSE, 0);
  ...
  gtk_box_pack_start(GTK_BOX(cajav3), rb2, FALSE, FALSE, 0);
  ...
  gtk_box_pack_start(GTK_BOX(cajahCR),cajav3,TRUE,TRUE,0);
  gtk_box_pack_start(GTK_BOX(cajav),cajahCR,TRUE,TRUE,5);
